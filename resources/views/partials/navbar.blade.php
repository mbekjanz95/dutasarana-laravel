...
<nav id="nav2" class="top-header flex">
    ...
    <div id="image-header" style="position: relative; display: inline-block;">
      <a href="/" style="position: absolute; left: 0; top: 0; width: 100px; height: 100%;"></a>
      <img width="375" height="68" style="margin-top: 9vh; z-index: 0" src="{{asset('tes-atas.png')}}" alt="logo-navbar-responsive">
  </div>
...
<nav id="nav3" class="navbar sticky flex navbar-shadow">
    <a href="/"><img class="logo" src="{{asset('logo-dsc.svg')}}" alt="logo-navbar"></a>
  ...
  <ul class="flex-icon">
      ...
      @endphp
        <li>
            <a href="/wishlist" class="navbar-icon position-relative">
                <i class="far fa-heart"></i>
                @if($wishlistCount > 0)
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-warning text-dark" 
                          style="font-size: 1rem; padding: 0.35em 0.55em; min-width: 20px; min-height: 20px; line-height: 1;">
                        {{ $wishlistCount }}
                    </span>
                @endif
            </a>
        ...
        <li class="icon-menu-space">
          <a href="/cart" class="navbar-icon position-relative">
...
<nav id="nav-responsive" class="d-flex navbar-shadow">
      ...
      <div class="burger">
        ...
        <div id="menu-categories" class="d-flex mt-5">
          <h5 class="menu-box active" data-type="menu">Menu</h5>
          <h5 class="menu-box" data-type="categories">Categories</h5>
        </div>
        ...
        <ul class="nav-list text-start mt-2" style="display: none">
          ...
          <li class="nav-item">
            <div class="nav-dropdown">&nbsp;DSC Store
              <span class="float-end plus"><i class="fas fa-plus"></i></span> 
            </div>
            <ul class="nav-submenu">
              <li class="nav-item"><a href="/branch-store" class="nav-link">Branch Store</a></li>
              <li class="nav-item"><a href="/maintenance" class="nav-link">Service Center</a></li>
            </ul>
          </li>
          <li class="nav-item"><a href="/our-marketplace" class="nav-link">Our Marketplace</a></li>
          <li class="nav-item"><a href="/pricelist" class="nav-link">Price List</a></li>
          <li class="nav-item"><a href="/all-promo" class="nav-link">All Promo</a></li>
          <li class="nav-item">
            <div class="nav-dropdown">&nbsp;More Info
              <span class="float-end plus"><i class="fas fa-plus"></i></span> 
            </div>
            <ul class="nav-submenu">
              <li class="nav-item"><a href="/our-award" class="nav-link">Our Award</a></li>
            </ul>
          </li>
          <li class="text-center mt-3">
            <form action="/logout" method="post">
              @csrf
              <button class="btn btn-danger"><i class="fas fa-power-off"></i>&nbsp;&nbsp;LOG OUT</button> 
            </form>
          </li>
        </ul>
    
        <ul class="nav-categories-list text-start mt-2" style="display: none">
          <li class="nav-item"><a href="{{ url('/top-categories') }}?nama_produk=LAPTOP" class="nav-link">Laptop</a></li>
          <li class="nav-item"><a href="{{ url('/top-categories') }}?nama_produk=PERSONAL COMPUTER" class="nav-link">Komputer</a></li>
          <li class="nav-item"><a href="{{ url('/top-categories') }}?nama_produk=PRINTER" class="nav-link">Printer</a></li>
          <li class="nav-item"><a href="{{ url('/top-categories') }}?nama_produk=LAINNYA" class="nav-link">Lainnya</a></li>
        </ul>
    
        <div id="copyright" style="opacity: 0.8;">
          <div class="mt-4">Copyright © 2025 • Dutasarana.id</div>
  ...
  <form class="src-produk-responsive mt-2" action="/cari-responsive" method="get">
    ...
    @auth
			<nav class="mobile-nav">
			  ...
			  <a href="/wishlist" class="position-relative d-inline-flex flex-column align-items-center">
            <i class="far fa-heart position-relative">
                @if($wishlistCount > 0)
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-warning text-dark"
                          style="font-size: 0.75rem; padding: 0.35em 0.55em; min-width: 20px; min-height: 20px; line-height: 1; transform: translate(-40%, -40%);">
                        {{ $wishlistCount }}
                    </span>
                @endif
            </i>
            <small>Wishlist</small>
				...
				<a href="/cart" class="position-relative d-inline-flex flex-column align-items-center">
...
<script>
  $(document).ready(function(){
    ...
    $('.close-btn').on('click', function() {
      ...
      $('.menu-box[data-type="menu"]').addClass('active');
      $('.menu-box[data-type="categories"]').removeClass('active');
      $('.nav-categories-list').hide();
    });
    ...
    $('.nav-dropdown').on('click', function () {
      ...
      $('.plus').not(plus).removeClass('rotated');
