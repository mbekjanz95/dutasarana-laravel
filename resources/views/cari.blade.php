...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Printer,PC,Tinta,Cartridge,Projector Canon,HP,Brother,Epson,ASUS,Acer">
    <title>DUTA SARANA COMPUTER - List Produk</title>
...
<div class="mt-5 container">   
    <div class="row">
        ...
        @empty
            <h1 class="mt-5" style="text-align: center;">Produk tidak ditemukan !</h1>
        @endforelse
    </div>
</div>

<div id="page-link">
    {{$hasil->links('vendor.pagination.bootstrap-5')}}
</div>
