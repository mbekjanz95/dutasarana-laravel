                    ...
                    <tbody id="isi-table"> 
                        @foreach ($produk as $row )
                            @if ($row->catname === 'CCTV' || $row->catname === 'PROJECTOR' || $row->catname === 'PRINTER' || $row->catname === 'SCANNER' || $row->catname === 'TABLET' || $row->catname === 'UPS')
                                <tr>
                                    <td class="text-center" style="padding-top: 40px;"><a href="/admin/{{$row->productname}}"><button class="btn btn-success">Edit Stok Produk</button></a></td>
                    ...
                    success: function(response){
                        ...
                        $.each(response, function(i, val){
                            ...
                            if (val.catname === 'CCTV' || val.catname === 'PROJECTOR' || val.catname === 'PRINTER' || val.catname === 'SCANNER' || val.catname === 'TABLET' || val.catname === 'UPS')
                            {
                                ...
                                `
                                    <tr>
                                    <td class="text-center" style="padding-top: 40px;"><a href="/admin/${val.productname}"><button class="btn btn-success">Edit Stok Produk</button></a></td>
